...
urlpatterns = patterns('',
    ...
    url(r'^addUserSuccess/$', views.addUserSuccess, name='addUserSuccess'),
    url(r'^removeUserSuccess/$', views.removeUserSuccess, name='removeUserSuccess'),
    url(r'^commentSuccess/$', views.commentSuccess, name='commentSuccess'),
    url(r'^commentDelete/(?P<comment_id>\d+)/$', views.commentDelete, name='commentDelete'),    
